...
# OSC paths
KNOB_PATH_PREFIX = "/sensors/analog/pot_"
...
class ElkUIController(object):
    ...
    def _register_osc_callbacks(self):
        for n in range(N_KNOBS):
            self._osc_server.add_method(KNOB_PATH_PREFIX + str(n), 'f', self._handle_knobs)
